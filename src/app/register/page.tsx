      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-auto">
            <h1 className="text-4xl font-bold text-white mb-6">{t('auth.register.subtitle')}</h1>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-slate-100">
            <h2 className="text-2xl font-bold text-slate-800 mb-2">{t('auth.register.title')}</h2>
            <p className="text-slate-500 mb-6">{t('auth.register.subtitle')}</p>
            ...
            <form onSubmit={submit} className="space-y-4">
              <div>
                <label htmlFor="name" className="block text-sm font-medium text-slate-700 mb-1.5">{t('auth.register.name')}</label>
                <input
                  id="name"
                  type="text" 
                  value={name}
                  onChange={(e) => setName(e.target.value)}
                  className="w-full px-4 py-2.5 border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-300 focus:border-blue-500 transition-colors" 
                  required
                />
              </div>
              ...
              <div>
                <label htmlFor="confirmPassword" className="block text-sm font-medium text-slate-700 mb-1.5">{t('auth.register.confirmPassword')}</label>
                <input
                  id="confirmPassword"
                  type="password" 
            ...
            <div className="mt-6 text-center text-sm text-slate-500">
              {t('auth.register.alreadyHaveAccount')} <Link href="/login" className="text-blue-600 hover:text-blue-800 font-medium">{t('auth.register.signIn')}</Link>
            </div>
          </div>
        </div>
      </div>
