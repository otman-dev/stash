              ...
              {isLoading ? (
                ...
                products.slice(0, 5).map((product: any) => (
                  <div key={product._id || product.id} className="p-6 flex items-center hover:bg-slate-50 transition-colors">
                    ...
                    <div className="ml-4">
                      <Link href={`/dashboard/products/${product._id || product.id}`} className="p-2 rounded-full text-slate-400 hover:text-blue-600 hover:bg-blue-50 transition-colors inline-flex">
